...
<html lang="en">
    <head>
        ...
        <title>About Maria House Ltd!</title>
...
<p>Additionally, we are proud to be actively involved in our local community, supporting various initiatives and charities that make a positive impact. We strive to be more than just a business; we aim to be a valued member of the community.</p>
        ...
        <fieldset>
            <form>
                <legend>What are you expecting from Maria House?:</legend>
                <label fo="fill_your_expectation_here">Fill your expectation here:</label>
                <input type="text" id="fill_your_expectation" name="fill_your_expectation" style="width: 300px; height: auto;"><br><br>
            </form>
        </fieldset>
    </body>
</html>